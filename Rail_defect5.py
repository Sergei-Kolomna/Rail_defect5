...
def calculate_dimensions(cropped_image, pixel_per_cm):
    ...
    for contour in contours:
        ...
        if area > 0:
            ...
            if dimensions > 1.8 and dimensions < 5.1:  # Check if area is more than 2 sq.cm.
...
def mouse_callback(event, x, y, flags, param):
    global point1, point2, frame_start, frame_end, frame_resizing, image
...
def on_key(event):
    global point1, point2, image, frame_start, frame_end
    ...
    if event == ord('a') and frame_start and frame_end:
        ...
        cropped_image = image[frame_start[1]:frame_end[1], frame_start[0]:frame_end[0]]
...
while True:
    ...
    if event in (None, 'Exit', 'Cancel'):
        break
    if event == 'Submit':
        image_path = values[0] #image_path = "image_test2.jpg"
        #
        #image_path = 'C://Users//Фокин//source//repos//Rail_defect5//image_test2.jpg'
        #
        #image_path = bytes(image_path, encoding='utf8')
